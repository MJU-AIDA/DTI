...
dev_df = pd.read_csv("old_vec_dev_origin.csv")
train_df = pd.read_csv("old_vec_train_origin.csv")
test_df = pd.read_csv("old_vec_test_origin.csv")
...
with open("old_dev.txt", "w") as f:
    f.write(dev_str)
with open("old_train.txt", "w") as f:
    f.write(train_str)
with open("old_test.txt", "w") as f:
    f.write(test_str)
